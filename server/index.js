...
// Popup.html als Startseite ausliefern
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "popup.html"));
});

// Optional: alle statischen Dateien (CSS, JS) bereitstellen
